    ...
    def __init__(self, type, fav_item_codes_list, fav_item_names_list, fast_item_codes_list, fast_item_names_list):
        ...
        ui_header_pane_layout = [
            [
                ...
                sg.Text('', **ap_style.page_title, pad=((0,0),(0,3)), key='_ESTIMATE_NUMBER_', background_color=background_color,visible=(eval("type=='estimate'"))),
                sg.Text('', **ap_style.page_title, pad=((0,0),(0,3)), key='_ORDER_NUMBER_', background_color=background_color,visible=(eval("type=='order'"))),
        ...
        ui_action_pane_layout = [
            [
                sg.Button(key='F1',  button_text='\nF1', **ap_style.action_button, pad=((3,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='F2',  button_text='\nF2', **ap_style.action_button, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='F3',  button_text='\nF3', **ap_style.action_button, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='F4',  button_text='\nF4', **ap_style.action_button, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='F5',  button_text='\nF5', **ap_style.action_button, pad=((print_left_pad,25),(5,0))),
                sg.Button(key='F6',  button_text='\nF6', **ap_style.action_button_small, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='F7',  button_text='\nF7', **ap_style.action_button_small, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='F8',  button_text='\nF8', **ap_style.action_button_small, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='F9',  button_text='\nF9', **ap_style.action_button_small, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='+',  button_text='\n+', **ap_style.action_button_small, pad=((20,5),(5,0)),visible=(eval("type=='estimate'"))),
                sg.Button(key='-',  button_text='\n-', **ap_style.action_button_small, pad=((0,5),(5,0)),visible=(eval("type=='estimate'"))),
        ...
        ui_tools_pane_layout = [
            [
                sg.Button('ADDON  (Alt-A)', key='Addon', **ap_style.search_button_wide,visible=(eval("type=='estimate'")))
            ],
            [
                sg.Button('BUNDLE  (Alt-B)', key='Bundle', **ap_style.search_button_wide,visible=(eval("type=='estimate'")))
            ],
        ]
        ...
        ui_left_panes_layout = [
            ...
            [
                sg.Frame('',
                    ...
                    border_width = 0,                   
                    pad = ((5,0),(7,5)),
                    background_color=background_color, visible=(eval("type=='estimate'"))
                )     
            ],
            [
                sg.Frame('',
