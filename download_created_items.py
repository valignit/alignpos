...
# Installation: AFSM
# CLI Program: download_created_items
# Description: Get the new Items created after the last download.
#              Insert into the Items table in local db
# Version: 1.0
...
# Main
##############################
print_log('alignPOS - Download Created Items - Version 1.1')
print_log('-----------------------------------------------')
...
for ws_erp_row_item in ws_erp_resp_json["items"]:
    ...
    last_sync_date_time = ws_erp_row_item["creation"]
...
######    
# Closing Log file 
print_log("Download Created Items process completed")
file_log.close()
