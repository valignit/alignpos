...
class Estimate():
    ...
    def __init__(estimate, db_conn, window):
        estimate.db_conn = db_conn
        estimate.ui_window = window
        
        estimate.ui_title_pane = UiTitlePane(window)
        estimate.ui_header_pane = UiHeaderPane(window)
        estimate.ui_search_pane = UiSearchPane(window)
        estimate.ui_detail_pane = UiDetailPane(window)
        estimate.ui_action_pane = UiActionPane(window)
        estimate.ui_summary_pane = UiSummaryPane(window)
