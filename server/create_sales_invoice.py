...
# Application:  ERPNext
# Installation: AFSM
# Server Script Doc Event:  create_sales_invoice
#               Doc Type:   Alignpos Invoice
#               Event:      After Save
# Description:  Automatically create Sales Invoice when the Alignpos Invoice is saved
##################################################
