...
class EstimateUi:
    ...
    def __init__(self, window):
        ...
        self.__window['_ORDER_NUMBER_'].Widget.config(takefocus=0)
    ...
    def set_order_number(self, order_number):
        ...
        self.__window.Element('_ORDER_NUMBER_').update(value = self.__order_number)
        
    def get_order_number(self):
        self.__order_number = self.__window.Element('_ORDER_NUMBER_').get()        
